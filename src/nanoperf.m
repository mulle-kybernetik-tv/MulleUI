...
void renderGraph(NVGcontext* vg, float x, float y, PerfGraph* fps)
{
	...
	if (fps->name[0] != '\0') {
		...
		nvgTextColor(vg, nvgRGBA(240,240,240,192), nvgRGBA(255,192,0,128));
	...
	if (fps->style == GRAPH_RENDER_FPS) {
		...
		nvgTextColor(vg, nvgRGBA(240,240,240,255), nvgRGBA(255,192,0,128));
		sprintf(str, "%.2f FPS", 1.0f / avg);
		nvgText(vg, x+w-3,y+1, str, NULL);

		nvgFontSize(vg, 15.0f);
		nvgTextAlign(vg,NVG_ALIGN_RIGHT|NVG_ALIGN_BOTTOM);
		nvgTextColor(vg, nvgRGBA(240,240,240,160), nvgRGBA(255,192,0,128));
